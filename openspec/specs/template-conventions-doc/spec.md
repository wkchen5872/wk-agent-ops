# Spec: template-conventions-doc

## Purpose

Defines the requirements for the conventions documentation template (`template/common/docs/`) that ships with every profile, ensuring it remains language-agnostic and consistent with profile-specific language rules.
