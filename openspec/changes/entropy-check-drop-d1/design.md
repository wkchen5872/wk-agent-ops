...
**Update all three SKILL.md copies**: The skill exists in `template/common/`, `.claude/skills/`, and `.agents/skills/`. All three must be updated identically to stay in sync.
